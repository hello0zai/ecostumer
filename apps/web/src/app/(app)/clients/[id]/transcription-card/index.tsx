...
export function TranscriptionCard({
  ...
  const data = {
    transcription: {
      segments: [
        ...
        {
          id: '2',
          text: 'In this section, we will discuss the importance of user experience.',
          start: 15,
        },
        {
          id: '3',
          text: "Now, let's move on to the next topic: accessibility in design.",
          start: 45,
        },
      ],
    },
  ...
  return (
    <div className="relative">
      <Card className="absolute bottom-0 left-0 right-0 top-0 grid grid-rows-[min-content_1fr_min-content] data-[video-displayed=false]:grid-rows-[1fr_min-content]">
